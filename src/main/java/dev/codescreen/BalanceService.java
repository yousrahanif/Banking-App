...
//    }
	...
	private void applyEvent(Object event) {
		if (event instanceof FundsLoadedEvent) {
			...
			balances.put(loadEvent.getUserId(),
					balances.getOrDefault(loadEvent.getUserId(), 0.0) + loadEvent.getAmount());
			addToTransactionHistory(loadEvent.getUserId(), loadEvent.getAmount(), "Load", LocalDateTime.now(),
					"Success");
	...
	private void addToTransactionHistory(int userId, double amount, String type, LocalDateTime timestamp,
			String status) {
